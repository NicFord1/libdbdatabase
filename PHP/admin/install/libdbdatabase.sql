...
--
-- Host: 10.8.11.195
-- Generation Time: Jun 30, 2009 at 03:41 PM
...
--
-- Creation: Jun 20, 2009 at 10:28 AM
-- Last update: Jun 30, 2009 at 01:38 PM
-- Last check: Jun 20, 2009 at 11:52 PM
--

DROP TABLE IF EXISTS `ldb_activeguests`;
...
--
-- Creation: Jun 20, 2009 at 10:28 AM
-- Last update: Jun 30, 2009 at 01:39 PM
-- Last check: Jun 20, 2009 at 11:52 PM
--

DROP TABLE IF EXISTS `ldb_activeusers`;
...
INSERT DELAYED IGNORE INTO `ldb_activeusers` (`uid`, `timestamp`) VALUES
(3, 1246394287),
(1, 1246394383),
(2, 1246394280),
(0, 1246394287);
...
--
-- Creation: Jun 24, 2009 at 05:56 AM
-- Last update: Jun 30, 2009 at 01:38 PM
--
...
INSERT DELAYED IGNORE INTO `ldb_admins` (`uid`, `hiredate`) VALUES
(4, 1246394321),
(1, 1246393073);
...
--
-- Creation: Jun 20, 2009 at 10:28 AM
-- Last update: Jun 30, 2009 at 01:03 PM
-- Last check: Jun 20, 2009 at 11:52 PM
--

DROP TABLE IF EXISTS `ldb_bannedusers`;
...
--
-- Creation: Jun 25, 2009 at 03:47 AM
-- Last update: Jun 25, 2009 at 03:47 AM
--

DROP TABLE IF EXISTS `ldb_books`;
...
INSERT DELAYED IGNORE INTO `ldb_books` (`itemid`, `isbn`, `title`, `author`, `genre`, `publisher`, `releasedate`, `rating`, `description`, `cost`, `latefee`) VALUES
...
--
-- Creation: Jun 25, 2009 at 03:49 AM
-- Last update: Jun 25, 2009 at 03:49 AM
--

DROP TABLE IF EXISTS `ldb_borroweditems`;
...
INSERT DELAYED IGNORE INTO `ldb_borroweditems` (`itemid`, `uid`, `duedate`) VALUES
(7, 9, 1248973200),
(8, 9, 1248109200),
(8, 9, 1246035600),
(3, 13, 1249405200),
...
--
-- Creation: Jun 25, 2009 at 03:38 AM
-- Last update: Jun 25, 2009 at 03:47 AM
-- Last check: Jun 25, 2009 at 03:38 AM
--

DROP TABLE IF EXISTS `ldb_cds`;
...
INSERT DELAYED IGNORE INTO `ldb_cds` (`itemid`, `upc`, `title`, `author`, `genre`, `publisher`, `releasedate`, `rating`, `description`, `cost`, `latefee`) VALUES
...
--
-- Creation: Jun 30, 2009 at 01:16 PM
-- Last update: Jun 30, 2009 at 01:39 PM
-- Last check: Jun 30, 2009 at 01:16 PM
--
...
INSERT DELAYED IGNORE INTO `ldb_customers` (`uid`, `username`, `password`, `email`, `regtime`, `lastvisit`, `firstname`, `lastname`, `birthdate`, `gender`, `addrline1`, `addrline2`, `city`, `state`, `zip`, `phone`) VALUES
...
INSERT DELAYED IGNORE INTO `ldb_dvds` (`itemid`, `upc`, `title`, `author`, `genre`, `publisher`, `releasedate`, `rating`, `description`, `cost`, `latefee`) VALUES
...
--
-- Creation: Jun 25, 2009 at 03:55 AM
-- Last update: Jun 25, 2009 at 03:55 AM
--

DROP TABLE IF EXISTS `ldb_items`;
...
INSERT DELAYED IGNORE INTO `ldb_items` (`itemid`, `itemtype`, `quantity`) VALUES
(2, 'BOOK', 3),
(3, 'BOOK', 2),
(4, 'PERIODICAL', 5),
(5, 'PERIODICAL', 6),
...
DROP TABLE IF EXISTS `ldb_periodicals`;
...
INSERT DELAYED IGNORE INTO `ldb_periodicals` (`itemid`, `isbn`, `issn`, `sici`, `title`, `editor`, `genre`, `publisher`, `releasedate`, `rating`, `description`, `cost`, `latefee`) VALUES
...
--
-- Creation: Jun 24, 2009 at 07:58 PM
-- Last update: Jun 30, 2009 at 01:30 PM
-- Last check: Jun 30, 2009 at 01:15 PM
--
...
INSERT DELAYED IGNORE INTO `ldb_tellers` (`uid`, `hiredate`) VALUES
(3, 1246393844);
